defmodule HmacTest do
  ...
  test "rfc example" do
    k = from_hex "85:d6:be:78:57:55:6d:33:7f:44:52:fe:42:d5:06:a8:01:03:80:8a:fb:0d:b2:fd:4a:bf:f6:af:41:49:f5:1b"
    m = from_hex """
                  43 72 79 70 74 6f 67 72 61 70 68 69 63 20 46 6f
                  72 75 6d 20 52 65 73 65 61 72 63 68 20 47 72 6f
                  75 70
                 """
    t = from_hex "a8:06:1d:c1:30:51:36:c6:c2:2b:8b:af:0c:01:27:a9"

    assert Poly1305.hmac(m,k) == t
  ...
  test "test vector #1" do
    ...
    m = from_hex """
                  ...
                  00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                 """
    t = from_hex "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"
  ...
  test "test vector #2" do
    ...
    m = from_hex """
                 ...
                 """
    t = from_hex "36 e5 f6 b5 c5 e0 60 70 f0 ef ca 96 22 7a 86 3e"
  ...
  test "test vector #3" do
    ...
    m = from_hex """
                  ...
                  73 73 65 64 20 74 6f
                 """
    t = from_hex "f3 47 7e 7c d9 54 17 af 89 a6 b8 79 4c 31 0c f0"

    assert Poly1305.hmac(m,k) == t
  end

  test "test vector #4" do
    k = from_hex """
    ...
    m = from_hex """
                 ...
                 """
    t = from_hex "45 41 66 9a 7e aa ee 61 e7 08 dc 7c bc c5 eb 62"

    assert Poly1305.hmac(m,k) == t
  end

  test "test vector #5" do
    k = from_hex """
    ...
    m = from_hex """
                 ...
                 """
    t = from_hex "03 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"

    assert Poly1305.hmac(m,k) == t
  end

  test "test vector #6" do
    k = from_hex """
                  02 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                  FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF
                 """
  ...
  test "test vector #7" do
    ...
    m = from_hex """
                 ...
                 """
    t = from_hex "05 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"

    assert Poly1305.hmac(m,k) == t
  end

  test "test vector #8" do
    k = from_hex """
                  01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                  00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                 """
  ...
  test "test vector #9" do
    ...
    m = from_hex """
                 ...
                 """
    t = from_hex "FA FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF"

    assert Poly1305.hmac(m,k) == t
  end

  test "test vector #10" do
    k = from_hex """
    ...
    m = from_hex """
                  ...
                  01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                 """
    t = from_hex "14 00 00 00 00 00 00 00 55 00 00 00 00 00 00 00"

    assert Poly1305.hmac(m,k) == t
  end

  test "test vector #11" do
    k = from_hex """
                  01 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00
                  00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                 """
    m = from_hex """
                  ...
                  00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                 """
    t = from_hex "13 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"
